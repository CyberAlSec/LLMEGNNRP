...
import stanza
from attack.MAYA.MG.parser import ConstituencyParser
from attack.MAYA.ADsamples_evaluation.eval_class import SentenceEncoder, GrammarChecker
from attack.MAYA.MG.rl import *
...
class MGAttacker:
    ...
    def sentence_process(self, sentence):
        ...
        phrases = [node[1] for node in nodes if node[3] and node[4]>20]
        indices = [node[2] for node in nodes if node[3] and node[4]>20]
