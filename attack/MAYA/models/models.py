...
from transformers import BertForSequenceClassification, BertTokenizer, \
    ...
    XLNetForSequenceClassification, XLNetTokenizer, AutoTokenizer, AutoConfig, AutoModelForSequenceClassification
...
class VictimAutoForSequenceClassification(VictimBert):
    def __init__(self,model_name,num_labels,load_path="infloat/e5-large",**kwargs):
        super().__init__(**kwargs)
